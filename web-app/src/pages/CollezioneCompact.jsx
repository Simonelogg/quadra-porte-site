...
const variants = [
  {
    file: 'compact%20mod%20c2-%20palissandro%20bianco.jpg',
    label: 'Mod. C2 · Palissandro Bianco',
    objPos: 'left center',
  },
  {
    file: 'compact%20incastri%203%20v-%20palissandro%20bianco-%20vertro%20satinato.jpg',
    label: 'Incastri 3V · Palissandro Bianco Vetro Satinato',
    objPos: 'left center',
  },
  {
    file: 'compact%20mod%20incastri%204v-%20palissandro%20bianco%20vetro%20satinato.jpg',
    label: 'Mod. Incastri 4V · Palissandro Bianco Vetro Satinato',
    objPos: 'right center',
  },
  {
    file: 'compact-%20palissandro%20bianco%20-%20vetro%20satinato.jpg',
    label: 'Palissandro Bianco · Vetro Satinato',
    objPos: 'left center',
  },
  {
    file: 'compact-%20palissandro%20bianco.jpg',
    label: 'Palissandro Bianco',
    objPos: 'center center',
  },
  {
    file: 'compact-%20palissandro%20blu.jpg',
    label: 'Palissandro Blu',
    objPos: 'left center',
  },
];
      ...
      <div className="pt-48 pb-24 px-4 md:px-8 max-w-[1400px] mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-[#6e6e73] text-sm max-w-xl leading-relaxed">
            L'incontro perfetto tra artigianalità e modernità. Incastri strutturali rinforzati, soluzioni con vetro e traversi per un design accogliente e durevole nel tempo. Disponibile in {variants.length} varianti.
          </p>
        </div>
        ...
        <FinishSection ids={['bianco-opaco', 'bianco-matrix']} />
