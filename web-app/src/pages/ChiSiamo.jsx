...
const values = [
  { icon: <Layers size={22} />, title: 'Artigianalità Industriale', desc: 'Ogni porta Quadra nasce da un processo produttivo che unisce la precisione industriale alla cura artigianale del dettaglio. Materiali selezionati e controllo qualità su ogni pezzo.' },
  { icon: <Award size={22} />, title: 'Certificazioni di Settore', desc: 'Tutti i prodotti rispettano le normative europee EN 1303 e RC3. Forniture certificate per il residenziale, il terziario e il contract di alto livello.' },
  { icon: <Users size={22} />, title: 'Progettazione Su Misura', desc: 'Il team tecnico affianca progettisti, interior designer e imprese edili dalla fase di sopralluogo fino alla posa finale, con supporto CAD e consulenza normativa.' },
  { icon: <MapPin size={22} />, title: 'Made in Sicily', desc: 'Produciamo a Caltanissetta, nel cuore della Sicilia. Il territorio, le persone e la qualità delle materie prime locali sono parte integrante dell\'identità Quadra.' },
];
  ...
  return (
    <div className="min-h-screen bg-white text-[#1d1d1f]">
      ...
      <div className="pt-40 pb-20 px-6 md:px-12 relative overflow-hidden"
        style={{ backgroundImage: `url('${import.meta.env.BASE_URL}images/pantografato.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="bg-[#0c0c0d] py-12 px-6 md:px-12">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-white/90 text-sm font-light tracking-wide">Quadra S.r.l. — Produzione italiana di porte interne e blindate di alta gamma dal 1998.</p>
      ...
      <div className="py-24 px-6 md:px-12 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-display font-bold tracking-tight text-[#1d1d1f]">Costruiamo con cura.<br />Progettiamo con visione.</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <div key={i} className="bg-[#f5f5f7] rounded-2xl p-7 border border-[#e0e0e0] hover:border-[#ea5d1a]/40 transition-colors group">
                <div className="w-12 h-12 rounded-xl bg-[#ea5d1a] flex items-center justify-center text-white mb-6 shadow-md group-hover:scale-105 transition-transform">{v.icon}</div>
      ...
      <div className="py-24 px-6 md:px-12 bg-[#f5f5f7]">
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-display font-bold tracking-tight text-[#1d1d1f]">I traguardi che ci definiscono.</h2>
          </div>
      ...
      <div className="py-24 px-6 md:px-12 bg-white">
        <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-display font-bold tracking-tight text-[#1d1d1f] mb-6">Produzione 100%<br />Italiana.</h2>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3 text-sm text-[#4a4a4a]">
                <span className="text-[#ea5d1a] font-bold text-xs">P.IVA</span>01981950858
              </div>
            </div>
          </div>
          <div className="rounded-[2rem] border border-[#e0e0e0] overflow-hidden h-80 shadow-sm">
            <iframe title="Quadra Sede" src="https://maps.google.com/maps?q=Caltanissetta,+Sicilia,+Italia&output=embed&z=12" className="w-full h-full border-0" loading="lazy" />
          </div>
        </div>
      </div>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="bg-[#1d1d1f] rounded-[2rem] p-10 md:p-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div>
              ...
              <p className="text-white/50 text-sm font-light max-w-lg leading-relaxed">Che tu sia un progettista, un'impresa edile o un privato, il team Quadra è pronto ad accompagnarti dalla scelta alla posa. Contattaci per un preventivo personalizzato senza impegno.</p>
            </div>
            <Link to="/#contatti" className="shrink-0 px-8 py-4 bg-[#ea5d1a] rounded-full text-white font-bold text-sm uppercase tracking-widest hover:bg-[#c94e15] transition-colors shadow-lg shadow-[#ea5d1a]/20">
              Contattaci
            </Link>
          </div>
        </div>
